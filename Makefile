...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue May 6 22:33:55 2014
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L. -L/usr/lib/x86_64-linux-gnu -lqwt -llevmar -llapack -lblas -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
